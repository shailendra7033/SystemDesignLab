...
> **Detailed API contract, DB schema, and error format**
> are in [docs/phase-01-single-server.md](docs/phase-01-single-server.md).
> Project structure and tech stack are in [docs/phase-00-projectsetup.md](docs/phase-00-projectsetup.md).
