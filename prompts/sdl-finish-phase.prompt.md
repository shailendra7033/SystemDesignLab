---
description: Wrap up the current System Design Lab phase and prepare for the next one
---

I think I'm done with the current phase. Do a thorough review:

1. **Deliverables check** — Read the Roadmap for this phase. List every feature/deliverable and verify each one exists in the codebase (code, tests, docs). Flag anything missing.
2. **Metrics** — What measurements should we capture now? (response times, query performance, resource usage). Run them and record results in the engineering journal.
